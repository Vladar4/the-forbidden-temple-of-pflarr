...
\tab 6 square 10'-wide \textbf{columns} adorned with masterful reliefs of jackal-headed figures engaged in various forms of arts and crafts.

\tab 6 \hyperlink{statue}{\textbf{jade living statues}}, 10' each one standing near a column, will attack any intruders on sight.
...
\begin{itemize}[leftmargin=*,label=\itshape\textbullet]
	...
	\item
	Filled with \hyperlink{gray-ooze}{gray ooze} and can squirt two \hyperlink{gray-ooze-blob}{blobs} per round from fingertips.
\end{itemize}
}
\vspace*{-\baselineskip}
